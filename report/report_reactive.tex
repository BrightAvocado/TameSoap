...
\begin{wrapfigure}{R}{0.5\textwidth}
	...
	\caption{Reward per distance traveled for 5 agents with different discount factors traveling in the Netherlands}
	\label{figure:1}
\end{wrapfigure}
...
In order to do that, we simultaneously ran 5 simulations with the following discount rates : 0.05, 0.1, 0.5, 0.85 and 0.99 using the configuration specified by the \texttt{E1reactive2.xml} file.\\
...
\begin{wrapfigure}{R}{0.5\textwidth}
	...
	\caption{Reward per distance traveled of an RLA trained agent (gamma = 0.99) and two dummy agents, accross four topologies}
	\label{figure:1}
\end{wrapfigure}
\subsubsection{Setting}
