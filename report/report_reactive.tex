...
We recorded the average profit of each agent every 50 actions, until the 5000th action had been made.\\
...
Another important observation is how the variation of the discount factor influences this value. There's barely any change for a discount factors ranging from 0.2 to 0.99. But once we read a discount factor of 0.2 and below, the "settling value" of the average profit increases in a quicker fashion.\\
% you describe the experimental results and the conclusions you inferred from these results

\subsection{Experiment 2: Comparisons with random agents}
